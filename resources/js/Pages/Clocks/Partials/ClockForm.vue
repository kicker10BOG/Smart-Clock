...
const form = useForm({
  name: computed(() => model.value.name),
  month_format: computed(() => model.value.month_format),
  weekday_format: computed(() => model.value.weekday_format),
  show_next_alarm: computed(() => model.value.show_next_alarm),
  show_seconds: computed(() => model.value.show_seconds),
  use_12hr: computed(() => model.value.use_12hr),
  show_ampm: computed(() => model.value.show_ampm),
  shorten_ampm: computed(() => model.value.shorten_ampm),
  date_order: computed(() => model.value.date_order),
  clock_order: computed(() => model.value.clock_order),
  alarm_order: computed(() => model.value.alarm_order),
  date_size: computed(() => model.value.date_size),
  clock_size: computed(() => model.value.clock_size),
  alarm_size: computed(() => model.value.alarm_size),
  date_margin: computed(() => model.value.date_margin),
  clock_margin: computed(() => model.value.clock_margin),
  alarm_margin: computed(() => model.value.alarm_margin),
  date_font: computed(() => model.value.date_font),
  clock_font: computed(() => model.value.clock_font),
  alarm_font: computed(() => model.value.alarm_font),
})
